...
if __name__ == '__main__':
    ...
    # define the model
    decoder = Sequential()
    decoder.add(ConvLSTM2D(latent_dim, (10, 1), input_shape=(1024, 1, 23, 14), data_format='channels_first', return_sequences=True))
    decoder.add(ConvLSTM2D(latent_dim, (10, 1), return_sequences=True, data_format='channels_first'))
